...
import underworld.meshing._meshing as mesh
import underworld.fields._fields as field
import underworld.swarms._swarms as swarm
import underworld.matrix._matrix as matrix
import underworld.shapes._shapes as shape
import underworld.rheology._rheology as rheo
import underworld.boundary._boundary as bc
import underworld.equations._equations as eq
import underworld.geometry._geometry as geom
import underworld.physics._physics as phys
import underworld.visualisation._visualisation as vis
...
underworld.solvers._multigrid.multigrid(3)

underworld.solvers._options.options(optionsString="-A11_ksp_type fgmres -A11_ksp_converged_reason -xxscr_ksp_view -Q22_pc_type gkgdiag -log_summary", optionsFilename="options/options-scr-mg.opt")
