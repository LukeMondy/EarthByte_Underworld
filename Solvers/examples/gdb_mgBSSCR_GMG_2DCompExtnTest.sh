...
#
#
#   With current configuration: (output identical to mgBSSCR_NaiNai_2DCompExtnTest.sh with -forcecorrection false) (note that penalty=2.5 here)
...
#
#   With 128x64 mesh:   (output identical to mgBSSCR_NaiNai_2DCompExtnTest.sh with -forcecorrection false and 128x64 mesh) (note that penalty=2.5 here)
...
$UWEXEC $UWPATH/Underworld/InputFiles/+LithosphereSandbox/Sandbox2D.xml $UWPATH/Underworld/InputFiles/Sandbox2DOverRide.xml \
    ...
    -options_file ./options-scr-mg-accelerating.opt \
		...
		--components.constitutiveMatrix.viscosity_weighting=false \
  		...
  		-XQ22_pc_type uwscale -Xrestore_K -no_scale \
