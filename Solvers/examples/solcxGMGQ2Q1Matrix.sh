...
#NAME="solcxGMG"
#NAME="Q2P1Solcx"
NAME="q2q1runsSolCx_conditionNumberMatrices"
NAME="NNq2q1runsSolCx_condMat"
...
$UWEXEC $UWPATH/Solvers/InputFiles/testVelicSolCxQ2Q1Nearest.xml \
    ...
    $MGOP \
  		...
  		-Q22_pc_type $UW \
  		-XQ22_pc_type gtkg -Xrestore_K $SCALE -restore_K_after_solve 0 \
  		...
  		--elementResI=$RES --elementResJ=$RES \
                --maxTimeSteps=10 -dump_matvec -matsuffix "_${RES}x${RES}_${SCALETEXT}_10e${VC}_cx_" -matdumpdir $OUT -solutiondumpdir $OUT \
