#ifndef __PICellerator_Common_Ppc_Auto_Thermal_Profile_h__
#define __PICellerator_Common_Ppc_Auto_Thermal_Profile_h__

/** Textual name of this class */
extern const Type Ppc_Auto_Thermal_Profile_Type;

/** Ppc_Auto_Thermal_Profile class contents */
#define __Ppc_Auto_Thermal_Profile				\
		/* Parent info */ \
		__Ppc \
		/* General data */ \
		double start_coord; \
	...
	struct Ppc_Auto_Thermal_Profile { __Ppc_Auto_Thermal_Profile };
	...
	Ppc_Auto_Thermal_Profile* _Ppc_Auto_Thermal_Profile_New(  PPC_OPERATION_DEFARGS  );
   ...
   /* Public functions */
	int _Ppc_Auto_Thermal_Profile_Get( void* _self, Element_LocalIndex lElement_I, IntegrationPoint* particle, double* result );
