...
#ifndef __Experimental_plugins_Tellus_h__
#define __Experimental_plugins_Tellus_h__

extern const Type Experimental_Tellus_Type;

typedef struct {
    __Codelet
    char* surfaceFile;
    char* initialSurfaceFile;
    char* inputName;
    char* depositName;
    char* dispName;
    char* outdirName;
    char curInputName[1000];
    int checkfreq;
} Experimental_Tellus;
...
void Experimental_Tellus_Finalise();
