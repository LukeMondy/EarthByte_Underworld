...
const Type ImportersToolbox_Toolbox_Type = "ImportersToolbox_Toolbox";

void _ImportersToolbox_Toolbox_AssignFromXML( void* component, Stg_ComponentFactory* cf, void* ptrToContext ) {
	/* Do nothing! */
}


void* _ImportersToolbox_Toolbox_DefaultNew( Name name ) {
	return Codelet_New(
			ImportersToolbox_Toolbox_Type,
			_ImportersToolbox_Toolbox_DefaultNew,
			_ImportersToolbox_Toolbox_AssignFromXML,
			_Codelet_Build,
			_Codelet_Initialise,
			_Codelet_Execute,
			_Codelet_Destroy,
...
void ImportersToolbox_Toolbox_Initialise( PluginsManager* pluginsManager, int* argc, char*** argv ) {
	ImportersToolbox_Init( argc, argv );
}
