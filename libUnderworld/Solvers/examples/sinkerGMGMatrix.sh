...
for VC in 3 6 9
do
for MG in gmg boomeramg boomeramgfs ml
do
for SC in 0 1
do
for UW in gkgdiag
...
$UWEXEC $UWPATH/Solvers/InputFiles/sinker.xml \
    ...
    $MGOP \
  		...
  		--maxTimeSteps=0 -Xdump_matvec -Xmatsuffix "_${RES}x${RES}_${SCALETEXT}_10e${VC}_sinker_" -NN $OUT \
    > "./$OUT/output.txt" 2>&1
