...
#multiply by 4 for equivalence to GMG method
PEN=`echo "4.0*$PEN" | bc -l`
...
#NAME="solcxGMG"
NAME="q1p0xsinkerViscPen_conditionNumber"
#NAME="penTest"
...
$UWEXEC $UWPATH/Solvers/InputFiles/sinker.xml \
    $UWPATH/Solvers/InputFiles/StokesPIC+AugmentedLagrangianBSSCR.xml \
