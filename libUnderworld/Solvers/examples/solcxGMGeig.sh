...
$UWEXEC $UWPATH/Underworld/SysTest/PerformanceTests/testVelicSolCx.xml \
   ...
   --components.stokesblockkspinterface.OptionsString="-A11_ksp_type preonly -A11_pc_type cholesky -A11_ksp_rtol 1e-3 -A11_ksp_monitor -backsolveA11_ksp_type preonly -backsolveA11_pc_type lu -scr_ksp_type cg -scr_pc_type none -scr_rtol 1e-20 -scr_ksp_compute_eigenvalues" \
#
