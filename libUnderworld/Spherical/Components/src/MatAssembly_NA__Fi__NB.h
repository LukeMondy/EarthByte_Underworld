...
#ifndef __Underworld_Utils_MatAssembly_NA__Fi__NB_h__
#define __Underworld_Utils_MatAssembly_NA__Fi__NB_h__

   /** Textual name of this class */
   extern const Type MatAssembly_NA__Fi__NB_Type;

   /** MatAssembly_NA__Fi__NB class contents */
   #define __MatAssembly_NA__Fi__NB \
      /* General info */ \
      __StiffnessMatrixTerm \
      \
      /* Virtual info */ \
      \
      /* MatAssembly_NA__Fi__NB info */ \
      PpcManager* ppcManager; \
      Stream*     errorStream; \
      int         grad_rho; \
      int         rho;

   struct MatAssembly_NA__Fi__NB { __MatAssembly_NA__Fi__NB };
