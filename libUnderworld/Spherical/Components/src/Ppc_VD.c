...
void _Ppc_VD_AssignFromXML( void* _self, Stg_ComponentFactory* cf, void* data )
{
   ...
   _Ppc_AssignFromXML( self, cf, data );
	self->strainRateTag = PpcManager_GetField( self->manager, cf, (Stg_Component*)self, "StrainRate", True );
	self->viscosityTag = PpcManager_GetField( self->manager, cf, (Stg_Component*)self, "Viscosity", True );
}
