...
model_input_files += pwd+"/temperatureICFromHDF5.xml "
model_input_files += "--components.numericalRheology.functionLabel=viscosity "
...
stgdict["Ra"]=Ra
stgdict["Di"]=Di
stgdict["outputPath"]=pwd+"/output/3.3_elRes_"+str(radial_elementRes)
