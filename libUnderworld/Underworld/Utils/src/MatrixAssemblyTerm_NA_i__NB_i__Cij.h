...
#ifndef __Underworld_Utils_MatrixAssemblyTerm_NA_i__NB_i__Cij_h__
#define __Underworld_Utils_MatrixAssemblyTerm_NA_i__NB_i__Cij_h__

   /** Textual name of this class */
   extern const Type MatrixAssemblyTerm_NA_i__NB_i__Cij_Type;

   /** MatrixAssemblyTerm_NA_i__NB_i__Cij class contents */
   #define __MatrixAssemblyTerm_NA_i__NB_i__Cij \
      /* General info */ \
      __StiffnessMatrixTerm \
      \
      /* Virtual info */ \
      \
      /* MatrixAssemblyTerm_NA_i__NB_i__Cij info */ \
      PpcManager* ppcManager; \
      Stream*     errorStream; \
      int         functionLabel; \
      int         nonlinearTag;

   struct MatrixAssemblyTerm_NA_i__NB_i__Cij { __MatrixAssemblyTerm_NA_i__NB_i__Cij };
