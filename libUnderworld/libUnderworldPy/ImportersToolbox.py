...
class VoxelFieldVariable(_object):
    ...
    if _newclass:
        _sizeOfSelf = _swig_property(_ImportersToolbox.VoxelFieldVariable__sizeOfSelf_get, _ImportersToolbox.VoxelFieldVariable__sizeOfSelf_set)
    ...
    if _newclass:
        _deleteSelf = _swig_property(_ImportersToolbox.VoxelFieldVariable__deleteSelf_get, _ImportersToolbox.VoxelFieldVariable__deleteSelf_set)
    ...
    if _newclass:
        type = _swig_property(_ImportersToolbox.VoxelFieldVariable_type_get, _ImportersToolbox.VoxelFieldVariable_type_set)
    ...
    if _newclass:
        nRefs = _swig_property(_ImportersToolbox.VoxelFieldVariable_nRefs_get, _ImportersToolbox.VoxelFieldVariable_nRefs_set)
    ...
    if _newclass:
        _delete = _swig_property(_ImportersToolbox.VoxelFieldVariable__delete_get, _ImportersToolbox.VoxelFieldVariable__delete_set)
    ...
    if _newclass:
        _print = _swig_property(_ImportersToolbox.VoxelFieldVariable__print_get, _ImportersToolbox.VoxelFieldVariable__print_set)
    ...
    if _newclass:
        _copy = _swig_property(_ImportersToolbox.VoxelFieldVariable__copy_get, _ImportersToolbox.VoxelFieldVariable__copy_set)
    ...
    if _newclass:
        name = _swig_property(_ImportersToolbox.VoxelFieldVariable_name_get, _ImportersToolbox.VoxelFieldVariable_name_set)
    ...
    if _newclass:
        nameAllocationType = _swig_property(_ImportersToolbox.VoxelFieldVariable_nameAllocationType_get, _ImportersToolbox.VoxelFieldVariable_nameAllocationType_set)
    ...
    if _newclass:
        _defaultConstructor = _swig_property(_ImportersToolbox.VoxelFieldVariable__defaultConstructor_get, _ImportersToolbox.VoxelFieldVariable__defaultConstructor_set)
    ...
    if _newclass:
        _construct = _swig_property(_ImportersToolbox.VoxelFieldVariable__construct_get, _ImportersToolbox.VoxelFieldVariable__construct_set)
    ...
    if _newclass:
        _build = _swig_property(_ImportersToolbox.VoxelFieldVariable__build_get, _ImportersToolbox.VoxelFieldVariable__build_set)
    ...
    if _newclass:
        _initialise = _swig_property(_ImportersToolbox.VoxelFieldVariable__initialise_get, _ImportersToolbox.VoxelFieldVariable__initialise_set)
    ...
    if _newclass:
        _execute = _swig_property(_ImportersToolbox.VoxelFieldVariable__execute_get, _ImportersToolbox.VoxelFieldVariable__execute_set)
    ...
    if _newclass:
        _destroy = _swig_property(_ImportersToolbox.VoxelFieldVariable__destroy_get, _ImportersToolbox.VoxelFieldVariable__destroy_set)
    ...
    if _newclass:
        isConstructed = _swig_property(_ImportersToolbox.VoxelFieldVariable_isConstructed_get, _ImportersToolbox.VoxelFieldVariable_isConstructed_set)
    ...
    if _newclass:
        isBuilt = _swig_property(_ImportersToolbox.VoxelFieldVariable_isBuilt_get, _ImportersToolbox.VoxelFieldVariable_isBuilt_set)
    ...
    if _newclass:
        isInitialised = _swig_property(_ImportersToolbox.VoxelFieldVariable_isInitialised_get, _ImportersToolbox.VoxelFieldVariable_isInitialised_set)
    ...
    if _newclass:
        hasExecuted = _swig_property(_ImportersToolbox.VoxelFieldVariable_hasExecuted_get, _ImportersToolbox.VoxelFieldVariable_hasExecuted_set)
    ...
    if _newclass:
        isDestroyed = _swig_property(_ImportersToolbox.VoxelFieldVariable_isDestroyed_get, _ImportersToolbox.VoxelFieldVariable_isDestroyed_set)
    ...
    if _newclass:
        constructType = _swig_property(_ImportersToolbox.VoxelFieldVariable_constructType_get, _ImportersToolbox.VoxelFieldVariable_constructType_set)
    ...
    if _newclass:
        buildType = _swig_property(_ImportersToolbox.VoxelFieldVariable_buildType_get, _ImportersToolbox.VoxelFieldVariable_buildType_set)
    ...
    if _newclass:
        initialiseType = _swig_property(_ImportersToolbox.VoxelFieldVariable_initialiseType_get, _ImportersToolbox.VoxelFieldVariable_initialiseType_set)
    ...
    if _newclass:
        executeType = _swig_property(_ImportersToolbox.VoxelFieldVariable_executeType_get, _ImportersToolbox.VoxelFieldVariable_executeType_set)
    ...
    if _newclass:
        destroyType = _swig_property(_ImportersToolbox.VoxelFieldVariable_destroyType_get, _ImportersToolbox.VoxelFieldVariable_destroyType_set)
    ...
    if _newclass:
        context = _swig_property(_ImportersToolbox.VoxelFieldVariable_context_get, _ImportersToolbox.VoxelFieldVariable_context_set)
    ...
    if _newclass:
        _interpolateValueAt = _swig_property(_ImportersToolbox.VoxelFieldVariable__interpolateValueAt_get, _ImportersToolbox.VoxelFieldVariable__interpolateValueAt_set)
    ...
    if _newclass:
        _getMinGlobalFieldMagnitude = _swig_property(_ImportersToolbox.VoxelFieldVariable__getMinGlobalFieldMagnitude_get, _ImportersToolbox.VoxelFieldVariable__getMinGlobalFieldMagnitude_set)
    ...
    if _newclass:
        _getMaxGlobalFieldMagnitude = _swig_property(_ImportersToolbox.VoxelFieldVariable__getMaxGlobalFieldMagnitude_get, _ImportersToolbox.VoxelFieldVariable__getMaxGlobalFieldMagnitude_set)
    ...
    if _newclass:
        _cacheMinMaxGlobalFieldMagnitude = _swig_property(_ImportersToolbox.VoxelFieldVariable__cacheMinMaxGlobalFieldMagnitude_get, _ImportersToolbox.VoxelFieldVariable__cacheMinMaxGlobalFieldMagnitude_set)
    ...
    if _newclass:
        _getMinAndMaxLocalCoords = _swig_property(_ImportersToolbox.VoxelFieldVariable__getMinAndMaxLocalCoords_get, _ImportersToolbox.VoxelFieldVariable__getMinAndMaxLocalCoords_set)
    ...
    if _newclass:
        _getMinAndMaxGlobalCoords = _swig_property(_ImportersToolbox.VoxelFieldVariable__getMinAndMaxGlobalCoords_get, _ImportersToolbox.VoxelFieldVariable__getMinAndMaxGlobalCoords_set)
    ...
    if _newclass:
        extensionMgr = _swig_property(_ImportersToolbox.VoxelFieldVariable_extensionMgr_get, _ImportersToolbox.VoxelFieldVariable_extensionMgr_set)
    ...
    if _newclass:
        fieldComponentCount = _swig_property(_ImportersToolbox.VoxelFieldVariable_fieldComponentCount_get, _ImportersToolbox.VoxelFieldVariable_fieldComponentCount_set)
    ...
    if _newclass:
        dim = _swig_property(_ImportersToolbox.VoxelFieldVariable_dim_get, _ImportersToolbox.VoxelFieldVariable_dim_set)
    ...
    if _newclass:
        communicator = _swig_property(_ImportersToolbox.VoxelFieldVariable_communicator_get, _ImportersToolbox.VoxelFieldVariable_communicator_set)
    ...
    if _newclass:
        fieldVariable_Register = _swig_property(_ImportersToolbox.VoxelFieldVariable_fieldVariable_Register_get, _ImportersToolbox.VoxelFieldVariable_fieldVariable_Register_set)
    ...
    if _newclass:
        isCheckpointedAndReloaded = _swig_property(_ImportersToolbox.VoxelFieldVariable_isCheckpointedAndReloaded_get, _ImportersToolbox.VoxelFieldVariable_isCheckpointedAndReloaded_set)
    ...
    if _newclass:
        isSavedData = _swig_property(_ImportersToolbox.VoxelFieldVariable_isSavedData_get, _ImportersToolbox.VoxelFieldVariable_isSavedData_set)
    ...
    if _newclass:
        cachedTimestep = _swig_property(_ImportersToolbox.VoxelFieldVariable_cachedTimestep_get, _ImportersToolbox.VoxelFieldVariable_cachedTimestep_set)
    ...
    if _newclass:
        magnitudeMin = _swig_property(_ImportersToolbox.VoxelFieldVariable_magnitudeMin_get, _ImportersToolbox.VoxelFieldVariable_magnitudeMin_set)
    ...
    if _newclass:
        magnitudeMax = _swig_property(_ImportersToolbox.VoxelFieldVariable_magnitudeMax_get, _ImportersToolbox.VoxelFieldVariable_magnitudeMax_set)
    ...
    if _newclass:
        theScaling = _swig_property(_ImportersToolbox.VoxelFieldVariable_theScaling_get, _ImportersToolbox.VoxelFieldVariable_theScaling_set)
    ...
    if _newclass:
        o_units = _swig_property(_ImportersToolbox.VoxelFieldVariable_o_units_get, _ImportersToolbox.VoxelFieldVariable_o_units_set)
    ...
    if _newclass:
        useCacheMaxMin = _swig_property(_ImportersToolbox.VoxelFieldVariable_useCacheMaxMin_get, _ImportersToolbox.VoxelFieldVariable_useCacheMaxMin_set)
    ...
    if _newclass:
        _setupDataArray = _swig_property(_ImportersToolbox.VoxelFieldVariable__setupDataArray_get, _ImportersToolbox.VoxelFieldVariable__setupDataArray_set)
    ...
    if _newclass:
        _testDataArray = _swig_property(_ImportersToolbox.VoxelFieldVariable__testDataArray_get, _ImportersToolbox.VoxelFieldVariable__testDataArray_set)
    ...
    if _newclass:
        _setArrayValue = _swig_property(_ImportersToolbox.VoxelFieldVariable__setArrayValue_get, _ImportersToolbox.VoxelFieldVariable__setArrayValue_set)
    ...
    if _newclass:
        _getArrayIndexIJK = _swig_property(_ImportersToolbox.VoxelFieldVariable__getArrayIndexIJK_get, _ImportersToolbox.VoxelFieldVariable__getArrayIndexIJK_set)
    ...
    if _newclass:
        voxelDataHandler = _swig_property(_ImportersToolbox.VoxelFieldVariable_voxelDataHandler_get, _ImportersToolbox.VoxelFieldVariable_voxelDataHandler_set)
    ...
    if _newclass:
        decompositionMesh = _swig_property(_ImportersToolbox.VoxelFieldVariable_decompositionMesh_get, _ImportersToolbox.VoxelFieldVariable_decompositionMesh_set)
    ...
    if _newclass:
        localCrdMin = _swig_property(_ImportersToolbox.VoxelFieldVariable_localCrdMin_get, _ImportersToolbox.VoxelFieldVariable_localCrdMin_set)
    ...
    if _newclass:
        localCrdMax = _swig_property(_ImportersToolbox.VoxelFieldVariable_localCrdMax_get, _ImportersToolbox.VoxelFieldVariable_localCrdMax_set)
    ...
    if _newclass:
        localStartCrd = _swig_property(_ImportersToolbox.VoxelFieldVariable_localStartCrd_get, _ImportersToolbox.VoxelFieldVariable_localStartCrd_set)
    ...
    if _newclass:
        arraySize = _swig_property(_ImportersToolbox.VoxelFieldVariable_arraySize_get, _ImportersToolbox.VoxelFieldVariable_arraySize_set)
    ...
    if _newclass:
        voxelDataArray = _swig_property(_ImportersToolbox.VoxelFieldVariable_voxelDataArray_get, _ImportersToolbox.VoxelFieldVariable_voxelDataArray_set)
    ...
    if _newclass:
        dataType = _swig_property(_ImportersToolbox.VoxelFieldVariable_dataType_get, _ImportersToolbox.VoxelFieldVariable_dataType_set)
    ...
    if _newclass:
        localMin = _swig_property(_ImportersToolbox.VoxelFieldVariable_localMin_get, _ImportersToolbox.VoxelFieldVariable_localMin_set)
    ...
    if _newclass:
        localMax = _swig_property(_ImportersToolbox.VoxelFieldVariable_localMax_get, _ImportersToolbox.VoxelFieldVariable_localMax_set)
    ...
    if _newclass:
        zSliceCoord = _swig_property(_ImportersToolbox.VoxelFieldVariable_zSliceCoord_get, _ImportersToolbox.VoxelFieldVariable_zSliceCoord_set)
    ...
    if _newclass:
        useNearestCell = _swig_property(_ImportersToolbox.VoxelFieldVariable_useNearestCell_get, _ImportersToolbox.VoxelFieldVariable_useNearestCell_set)
    ...
    if _newclass:
        useExternalArray = _swig_property(_ImportersToolbox.VoxelFieldVariable_useExternalArray_get, _ImportersToolbox.VoxelFieldVariable_useExternalArray_set)
    ...
    if _newclass:
        errorStream = _swig_property(_ImportersToolbox.VoxelFieldVariable_errorStream_get, _ImportersToolbox.VoxelFieldVariable_errorStream_set)
    ...
    if _newclass:
        minMaxCached = _swig_property(_ImportersToolbox.VoxelFieldVariable_minMaxCached_get, _ImportersToolbox.VoxelFieldVariable_minMaxCached_set)
...
def _VoxelFieldVariable_DefaultNew(name):
    return _ImportersToolbox._VoxelFieldVariable_DefaultNew(name)
_VoxelFieldVariable_DefaultNew = _ImportersToolbox._VoxelFieldVariable_DefaultNew

def _VoxelFieldVariable_New(_sizeOfSelf, type, _delete, _print, _copy, name, nameAllocationType, _defaultConstructor, _construct, _build, _initialise, _execute, _destroy, _interpolateValueAt, _getMinGlobalFieldMagnitude, _getMaxGlobalFieldMagnitude, _cacheMinMaxGlobalFieldMagnitude, _getMinAndMaxLocalCoords, _getMinAndMaxGlobalCoords, _setupDataArray, _testDataArray, _setArrayValue, _getArrayIndexIJK):
    return _ImportersToolbox._VoxelFieldVariable_New(_sizeOfSelf, type, _delete, _print, _copy, name, nameAllocationType, _defaultConstructor, _construct, _build, _initialise, _execute, _destroy, _interpolateValueAt, _getMinGlobalFieldMagnitude, _getMaxGlobalFieldMagnitude, _cacheMinMaxGlobalFieldMagnitude, _getMinAndMaxLocalCoords, _getMinAndMaxGlobalCoords, _setupDataArray, _testDataArray, _setArrayValue, _getArrayIndexIJK)
_VoxelFieldVariable_New = _ImportersToolbox._VoxelFieldVariable_New

def _VoxelFieldVariable_AssignFromXML(VoxelFieldVariable, cf, data):
    return _ImportersToolbox._VoxelFieldVariable_AssignFromXML(VoxelFieldVariable, cf, data)
_VoxelFieldVariable_AssignFromXML = _ImportersToolbox._VoxelFieldVariable_AssignFromXML

def _VoxelFieldVariable_Build(VoxelFieldVariable, data):
    return _ImportersToolbox._VoxelFieldVariable_Build(VoxelFieldVariable, data)
_VoxelFieldVariable_Build = _ImportersToolbox._VoxelFieldVariable_Build

def _VoxelFieldVariable_Destroy(VoxelFieldVariable, data):
    return _ImportersToolbox._VoxelFieldVariable_Destroy(VoxelFieldVariable, data)
_VoxelFieldVariable_Destroy = _ImportersToolbox._VoxelFieldVariable_Destroy

def _VoxelFieldVariable_Initialise(VoxelFieldVariable, data):
    return _ImportersToolbox._VoxelFieldVariable_Initialise(VoxelFieldVariable, data)
_VoxelFieldVariable_Initialise = _ImportersToolbox._VoxelFieldVariable_Initialise

def _VoxelFieldVariable_InterpolateValueAt(voxelFieldVariable, coord, value):
    return _ImportersToolbox._VoxelFieldVariable_InterpolateValueAt(voxelFieldVariable, coord, value)
_VoxelFieldVariable_InterpolateValueAt = _ImportersToolbox._VoxelFieldVariable_InterpolateValueAt

def _VoxelFieldVariable_GetMinGlobalFieldMagnitude(voxelFieldVariable):
    return _ImportersToolbox._VoxelFieldVariable_GetMinGlobalFieldMagnitude(voxelFieldVariable)
_VoxelFieldVariable_GetMinGlobalFieldMagnitude = _ImportersToolbox._VoxelFieldVariable_GetMinGlobalFieldMagnitude

def _VoxelFieldVariable_GetMaxGlobalFieldMagnitude(voxelFieldVariable):
    return _ImportersToolbox._VoxelFieldVariable_GetMaxGlobalFieldMagnitude(voxelFieldVariable)
_VoxelFieldVariable_GetMaxGlobalFieldMagnitude = _ImportersToolbox._VoxelFieldVariable_GetMaxGlobalFieldMagnitude

def _VoxelFieldVariable_CacheMinMaxGlobalFieldMagnitude(voxelFieldVariable):
    return _ImportersToolbox._VoxelFieldVariable_CacheMinMaxGlobalFieldMagnitude(voxelFieldVariable)
...
def _VoxelFieldVariable_GetMinAndMaxLocalCoords(voxelFieldVariable, min, max):
    return _ImportersToolbox._VoxelFieldVariable_GetMinAndMaxLocalCoords(voxelFieldVariable, min, max)
_VoxelFieldVariable_GetMinAndMaxLocalCoords = _ImportersToolbox._VoxelFieldVariable_GetMinAndMaxLocalCoords

def _VoxelFieldVariable_GetMinAndMaxGlobalCoords(voxelFieldVariable, min, max):
    return _ImportersToolbox._VoxelFieldVariable_GetMinAndMaxGlobalCoords(voxelFieldVariable, min, max)
_VoxelFieldVariable_GetMinAndMaxGlobalCoords = _ImportersToolbox._VoxelFieldVariable_GetMinAndMaxGlobalCoords

def _VoxelFieldVariable_SetupDataArray(voxelFieldVariable):
    return _ImportersToolbox._VoxelFieldVariable_SetupDataArray(voxelFieldVariable)
_VoxelFieldVariable_SetupDataArray = _ImportersToolbox._VoxelFieldVariable_SetupDataArray

def _VoxelFieldVariable_TestDataArray(voxelFieldVariable):
    return _ImportersToolbox._VoxelFieldVariable_TestDataArray(voxelFieldVariable)
_VoxelFieldVariable_TestDataArray = _ImportersToolbox._VoxelFieldVariable_TestDataArray

def _VoxelFieldVariable_SetArrayValue(arg1, coord):
    return _ImportersToolbox._VoxelFieldVariable_SetArrayValue(arg1, coord)
_VoxelFieldVariable_SetArrayValue = _ImportersToolbox._VoxelFieldVariable_SetArrayValue

def _VoxelFieldVariable_GetArrayIndexIJK(arg1, coord, indexIJK):
    return _ImportersToolbox._VoxelFieldVariable_GetArrayIndexIJK(arg1, coord, indexIJK)
