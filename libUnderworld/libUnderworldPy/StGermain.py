...
class STreeNode(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, STreeNode, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, STreeNode, name)
    __repr__ = _swig_repr
    __swig_setmethods__["data"] = _StGermain.STreeNode_data_set
    __swig_getmethods__["data"] = _StGermain.STreeNode_data_get
    if _newclass:
        data = _swig_property(_StGermain.STreeNode_data_get, _StGermain.STreeNode_data_set)
    __swig_setmethods__["left"] = _StGermain.STreeNode_left_set
    __swig_getmethods__["left"] = _StGermain.STreeNode_left_get
    if _newclass:
        left = _swig_property(_StGermain.STreeNode_left_get, _StGermain.STreeNode_left_set)
    __swig_setmethods__["right"] = _StGermain.STreeNode_right_set
    __swig_getmethods__["right"] = _StGermain.STreeNode_right_get
    if _newclass:
        right = _swig_property(_StGermain.STreeNode_right_get, _StGermain.STreeNode_right_set)

    def __init__(self):
        this = _StGermain.new_STreeNode()
        try:
...
class ISetItem(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ISetItem, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ISetItem, name)
    __repr__ = _swig_repr
    __swig_setmethods__["key"] = _StGermain.ISetItem_key_set
    __swig_getmethods__["key"] = _StGermain.ISetItem_key_get
    if _newclass:
        key = _swig_property(_StGermain.ISetItem_key_get, _StGermain.ISetItem_key_set)
    __swig_setmethods__["next"] = _StGermain.ISetItem_next_set
    __swig_getmethods__["next"] = _StGermain.ISetItem_next_get
    if _newclass:
        next = _swig_property(_StGermain.ISetItem_next_get, _StGermain.ISetItem_next_set)

    def __init__(self):
        this = _StGermain.new_ISetItem()
        try:
            self.this.append(this)
        except:
            self.this = this
...
class IMapItem(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, IMapItem, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, IMapItem, name)
    __repr__ = _swig_repr
    __swig_setmethods__["key"] = _StGermain.IMapItem_key_set
    __swig_getmethods__["key"] = _StGermain.IMapItem_key_get
    if _newclass:
        key = _swig_property(_StGermain.IMapItem_key_get, _StGermain.IMapItem_key_set)
    __swig_setmethods__["val"] = _StGermain.IMapItem_val_set
    __swig_getmethods__["val"] = _StGermain.IMapItem_val_get
    if _newclass:
        val = _swig_property(_StGermain.IMapItem_val_get, _StGermain.IMapItem_val_set)
    __swig_setmethods__["next"] = _StGermain.IMapItem_next_set
    __swig_getmethods__["next"] = _StGermain.IMapItem_next_get
    if _newclass:
        next = _swig_property(_StGermain.IMapItem_next_get, _StGermain.IMapItem_next_set)

    def __init__(self):
        this = _StGermain.new_IMapItem()
        try:
            self.this.append(this)
        except:
            self.this = this
...
class RangeSet_Range(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, RangeSet_Range, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, RangeSet_Range, name)
    __repr__ = _swig_repr
    __swig_setmethods__["begin"] = _StGermain.RangeSet_Range_begin_set
    __swig_getmethods__["begin"] = _StGermain.RangeSet_Range_begin_get
    if _newclass:
        begin = _swig_property(_StGermain.RangeSet_Range_begin_get, _StGermain.RangeSet_Range_begin_set)
    __swig_setmethods__["end"] = _StGermain.RangeSet_Range_end_set
    __swig_getmethods__["end"] = _StGermain.RangeSet_Range_end_get
    if _newclass:
        end = _swig_property(_StGermain.RangeSet_Range_end_get, _StGermain.RangeSet_Range_end_set)
    __swig_setmethods__["step"] = _StGermain.RangeSet_Range_step_set
    __swig_getmethods__["step"] = _StGermain.RangeSet_Range_step_get
    if _newclass:
        step = _swig_property(_StGermain.RangeSet_Range_step_get, _StGermain.RangeSet_Range_step_set)

    def __init__(self):
        this = _StGermain.new_RangeSet_Range()
        try:
            self.this.append(this)
        except:
            self.this = this
...
class RangeSet_ParseStruct(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, RangeSet_ParseStruct, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, RangeSet_ParseStruct, name)
    __repr__ = _swig_repr
    __swig_setmethods__["_self"] = _StGermain.RangeSet_ParseStruct__self_set
    __swig_getmethods__["_self"] = _StGermain.RangeSet_ParseStruct__self_get
    if _newclass:
        _self = _swig_property(_StGermain.RangeSet_ParseStruct__self_get, _StGermain.RangeSet_ParseStruct__self_set)
    __swig_setmethods__["operand"] = _StGermain.RangeSet_ParseStruct_operand_set
    __swig_getmethods__["operand"] = _StGermain.RangeSet_ParseStruct_operand_get
    if _newclass:
        operand = _swig_property(_StGermain.RangeSet_ParseStruct_operand_get, _StGermain.RangeSet_ParseStruct_operand_set)
    __swig_setmethods__["range"] = _StGermain.RangeSet_ParseStruct_range_set
    __swig_getmethods__["range"] = _StGermain.RangeSet_ParseStruct_range_get
    if _newclass:
        range = _swig_property(_StGermain.RangeSet_ParseStruct_range_get, _StGermain.RangeSet_ParseStruct_range_set)
    __swig_setmethods__["newTree"] = _StGermain.RangeSet_ParseStruct_newTree_set
    __swig_getmethods__["newTree"] = _StGermain.RangeSet_ParseStruct_newTree_get
    if _newclass:
        newTree = _swig_property(_StGermain.RangeSet_ParseStruct_newTree_get, _StGermain.RangeSet_ParseStruct_newTree_set)
    __swig_setmethods__["nInds"] = _StGermain.RangeSet_ParseStruct_nInds_set
    __swig_getmethods__["nInds"] = _StGermain.RangeSet_ParseStruct_nInds_get
    if _newclass:
        nInds = _swig_property(_StGermain.RangeSet_ParseStruct_nInds_get, _StGermain.RangeSet_ParseStruct_nInds_set)
    __swig_setmethods__["inds"] = _StGermain.RangeSet_ParseStruct_inds_set
    __swig_getmethods__["inds"] = _StGermain.RangeSet_ParseStruct_inds_get
    if _newclass:
        inds = _swig_property(_StGermain.RangeSet_ParseStruct_inds_get, _StGermain.RangeSet_ParseStruct_inds_set)
    __swig_setmethods__["curInd"] = _StGermain.RangeSet_ParseStruct_curInd_set
    __swig_getmethods__["curInd"] = _StGermain.RangeSet_ParseStruct_curInd_get
    if _newclass:
        curInd = _swig_property(_StGermain.RangeSet_ParseStruct_curInd_get, _StGermain.RangeSet_ParseStruct_curInd_set)
    __swig_setmethods__["bytes"] = _StGermain.RangeSet_ParseStruct_bytes_set
    __swig_getmethods__["bytes"] = _StGermain.RangeSet_ParseStruct_bytes_get
    if _newclass:
        bytes = _swig_property(_StGermain.RangeSet_ParseStruct_bytes_get, _StGermain.RangeSet_ParseStruct_bytes_set)

    def __init__(self):
        this = _StGermain.new_RangeSet_ParseStruct()
        try:
            self.this.append(this)
        except:
            self.this = this
...
class IndexMapTuple(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, IndexMapTuple, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, IndexMapTuple, name)
    __repr__ = _swig_repr
    __swig_setmethods__["key"] = _StGermain.IndexMapTuple_key_set
    __swig_getmethods__["key"] = _StGermain.IndexMapTuple_key_get
    if _newclass:
        key = _swig_property(_StGermain.IndexMapTuple_key_get, _StGermain.IndexMapTuple_key_set)
    __swig_setmethods__["idx"] = _StGermain.IndexMapTuple_idx_set
    __swig_getmethods__["idx"] = _StGermain.IndexMapTuple_idx_get
    if _newclass:
        idx = _swig_property(_StGermain.IndexMapTuple_idx_get, _StGermain.IndexMapTuple_idx_set)

    def __init__(self):
        this = _StGermain.new_IndexMapTuple()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _StGermain.delete_IndexMapTuple
    __del__ = lambda self: None
IndexMapTuple_swigregister = _StGermain.IndexMapTuple_swigregister
IndexMapTuple_swigregister(IndexMapTuple)
IndexMap_Type = cvar.IndexMap_Type

class IndexMap(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, IndexMap, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, IndexMap, name)
    __repr__ = _swig_repr
    __swig_setmethods__["_sizeOfSelf"] = _StGermain.IndexMap__sizeOfSelf_set
    __swig_getmethods__["_sizeOfSelf"] = _StGermain.IndexMap__sizeOfSelf_get
    if _newclass:
        _sizeOfSelf = _swig_property(_StGermain.IndexMap__sizeOfSelf_get, _StGermain.IndexMap__sizeOfSelf_set)
    __swig_setmethods__["_deleteSelf"] = _StGermain.IndexMap__deleteSelf_set
    __swig_getmethods__["_deleteSelf"] = _StGermain.IndexMap__deleteSelf_get
    if _newclass:
        _deleteSelf = _swig_property(_StGermain.IndexMap__deleteSelf_get, _StGermain.IndexMap__deleteSelf_set)
    __swig_setmethods__["type"] = _StGermain.IndexMap_type_set
    __swig_getmethods__["type"] = _StGermain.IndexMap_type_get
    if _newclass:
        type = _swig_property(_StGermain.IndexMap_type_get, _StGermain.IndexMap_type_set)
    __swig_setmethods__["nRefs"] = _StGermain.IndexMap_nRefs_set
    __swig_getmethods__["nRefs"] = _StGermain.IndexMap_nRefs_get
    if _newclass:
        nRefs = _swig_property(_StGermain.IndexMap_nRefs_get, _StGermain.IndexMap_nRefs_set)
    __swig_setmethods__["_delete"] = _StGermain.IndexMap__delete_set
    __swig_getmethods__["_delete"] = _StGermain.IndexMap__delete_get
    if _newclass:
        _delete = _swig_property(_StGermain.IndexMap__delete_get, _StGermain.IndexMap__delete_set)
    __swig_setmethods__["_print"] = _StGermain.IndexMap__print_set
    __swig_getmethods__["_print"] = _StGermain.IndexMap__print_get
    if _newclass:
        _print = _swig_property(_StGermain.IndexMap__print_get, _StGermain.IndexMap__print_set)
    __swig_setmethods__["_copy"] = _StGermain.IndexMap__copy_set
    __swig_getmethods__["_copy"] = _StGermain.IndexMap__copy_get
    if _newclass:
        _copy = _swig_property(_StGermain.IndexMap__copy_get, _StGermain.IndexMap__copy_set)
    __swig_setmethods__["dictionary"] = _StGermain.IndexMap_dictionary_set
    __swig_getmethods__["dictionary"] = _StGermain.IndexMap_dictionary_get
    if _newclass:
        dictionary = _swig_property(_StGermain.IndexMap_dictionary_get, _StGermain.IndexMap_dictionary_set)
    __swig_setmethods__["delta"] = _StGermain.IndexMap_delta_set
    __swig_getmethods__["delta"] = _StGermain.IndexMap_delta_get
    if _newclass:
        delta = _swig_property(_StGermain.IndexMap_delta_get, _StGermain.IndexMap_delta_set)
    __swig_setmethods__["maxTuples"] = _StGermain.IndexMap_maxTuples_set
    __swig_getmethods__["maxTuples"] = _StGermain.IndexMap_maxTuples_get
    if _newclass:
        maxTuples = _swig_property(_StGermain.IndexMap_maxTuples_get, _StGermain.IndexMap_maxTuples_set)
    __swig_setmethods__["tupleCnt"] = _StGermain.IndexMap_tupleCnt_set
    __swig_getmethods__["tupleCnt"] = _StGermain.IndexMap_tupleCnt_get
    if _newclass:
        tupleCnt = _swig_property(_StGermain.IndexMap_tupleCnt_get, _StGermain.IndexMap_tupleCnt_set)
    __swig_setmethods__["tupleTbl"] = _StGermain.IndexMap_tupleTbl_set
    __swig_getmethods__["tupleTbl"] = _StGermain.IndexMap_tupleTbl_get
    if _newclass:
        tupleTbl = _swig_property(_StGermain.IndexMap_tupleTbl_get, _StGermain.IndexMap_tupleTbl_set)

    def __init__(self):
        this = _StGermain.new_IndexMap()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _StGermain.delete_IndexMap
    __del__ = lambda self: None
IndexMap_swigregister = _StGermain.IndexMap_swigregister
IndexMap_swigregister(IndexMap)

INDEXMAP_DEFAULT_DELTA = _StGermain.INDEXMAP_DEFAULT_DELTA

def IndexMap_New_Param(delta):
    return _StGermain.IndexMap_New_Param(delta)
IndexMap_New_Param = _StGermain.IndexMap_New_Param

def _IndexMap_New(_sizeOfSelf, type, _delete, _print, _copy, delta):
    return _StGermain._IndexMap_New(_sizeOfSelf, type, _delete, _print, _copy, delta)
_IndexMap_New = _StGermain._IndexMap_New

def IndexMap_Init(arg1, delta):
    return _StGermain.IndexMap_Init(arg1, delta)
IndexMap_Init = _StGermain.IndexMap_Init

def _IndexMap_Init(arg1, delta):
    return _StGermain._IndexMap_Init(arg1, delta)
_IndexMap_Init = _StGermain._IndexMap_Init

def _IndexMap_Delete(indexMap):
    return _StGermain._IndexMap_Delete(indexMap)
_IndexMap_Delete = _StGermain._IndexMap_Delete

def _IndexMap_Print(indexMap, stream):
    return _StGermain._IndexMap_Print(indexMap, stream)
_IndexMap_Print = _StGermain._IndexMap_Print

def _IndexMap_Copy(indexMap, dest, deep, nameExt, ptrMap):
    return _StGermain._IndexMap_Copy(indexMap, dest, deep, nameExt, ptrMap)
_IndexMap_Copy = _StGermain._IndexMap_Copy

def IndexMap_Append(indexMap, key, idx):
    return _StGermain.IndexMap_Append(indexMap, key, idx)
IndexMap_Append = _StGermain.IndexMap_Append

def IndexMap_Find(indexMap, key):
    return _StGermain.IndexMap_Find(indexMap, key)
IndexMap_Find = _StGermain.IndexMap_Find

def IndexMap_Remap(indexMap, mapThrough):
    return _StGermain.IndexMap_Remap(indexMap, mapThrough)
IndexMap_Remap = _StGermain.IndexMap_Remap
class IndexSet(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, IndexSet, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, IndexSet, name)
    __repr__ = _swig_repr
    __swig_setmethods__["_sizeOfSelf"] = _StGermain.IndexSet__sizeOfSelf_set
    __swig_getmethods__["_sizeOfSelf"] = _StGermain.IndexSet__sizeOfSelf_get
    if _newclass:
        _sizeOfSelf = _swig_property(_StGermain.IndexSet__sizeOfSelf_get, _StGermain.IndexSet__sizeOfSelf_set)
    __swig_setmethods__["_deleteSelf"] = _StGermain.IndexSet__deleteSelf_set
    __swig_getmethods__["_deleteSelf"] = _StGermain.IndexSet__deleteSelf_get
    if _newclass:
        _deleteSelf = _swig_property(_StGermain.IndexSet__deleteSelf_get, _StGermain.IndexSet__deleteSelf_set)
    __swig_setmethods__["type"] = _StGermain.IndexSet_type_set
    __swig_getmethods__["type"] = _StGermain.IndexSet_type_get
    if _newclass:
        type = _swig_property(_StGermain.IndexSet_type_get, _StGermain.IndexSet_type_set)
    __swig_setmethods__["nRefs"] = _StGermain.IndexSet_nRefs_set
    __swig_getmethods__["nRefs"] = _StGermain.IndexSet_nRefs_get
    if _newclass:
        nRefs = _swig_property(_StGermain.IndexSet_nRefs_get, _StGermain.IndexSet_nRefs_set)
    __swig_setmethods__["_delete"] = _StGermain.IndexSet__delete_set
    __swig_getmethods__["_delete"] = _StGermain.IndexSet__delete_get
    if _newclass:
        _delete = _swig_property(_StGermain.IndexSet__delete_get, _StGermain.IndexSet__delete_set)
    __swig_setmethods__["_print"] = _StGermain.IndexSet__print_set
    __swig_getmethods__["_print"] = _StGermain.IndexSet__print_get
    if _newclass:
        _print = _swig_property(_StGermain.IndexSet__print_get, _StGermain.IndexSet__print_set)
    __swig_setmethods__["_copy"] = _StGermain.IndexSet__copy_set
    __swig_getmethods__["_copy"] = _StGermain.IndexSet__copy_get
    if _newclass:
        _copy = _swig_property(_StGermain.IndexSet__copy_get, _StGermain.IndexSet__copy_set)
    __swig_setmethods__["_duplicate"] = _StGermain.IndexSet__duplicate_set
    __swig_getmethods__["_duplicate"] = _StGermain.IndexSet__duplicate_get
    if _newclass:
        _duplicate = _swig_property(_StGermain.IndexSet__duplicate_get, _StGermain.IndexSet__duplicate_set)
    __swig_setmethods__["error"] = _StGermain.IndexSet_error_set
    __swig_getmethods__["error"] = _StGermain.IndexSet_error_get
    if _newclass:
        error = _swig_property(_StGermain.IndexSet_error_get, _StGermain.IndexSet_error_set)
    __swig_setmethods__["size"] = _StGermain.IndexSet_size_set
    __swig_getmethods__["size"] = _StGermain.IndexSet_size_get
    if _newclass:
        size = _swig_property(_StGermain.IndexSet_size_get, _StGermain.IndexSet_size_set)
    __swig_setmethods__["_containerSize"] = _StGermain.IndexSet__containerSize_set
    __swig_getmethods__["_containerSize"] = _StGermain.IndexSet__containerSize_get
    if _newclass:
        _containerSize = _swig_property(_StGermain.IndexSet__containerSize_get, _StGermain.IndexSet__containerSize_set)
    __swig_setmethods__["_container"] = _StGermain.IndexSet__container_set
    __swig_getmethods__["_container"] = _StGermain.IndexSet__container_get
    if _newclass:
        _container = _swig_property(_StGermain.IndexSet__container_get, _StGermain.IndexSet__container_set)
    __swig_setmethods__["membersCount"] = _StGermain.IndexSet_membersCount_set
    __swig_getmethods__["membersCount"] = _StGermain.IndexSet_membersCount_get
    if _newclass:
        membersCount = _swig_property(_StGermain.IndexSet_membersCount_get, _StGermain.IndexSet_membersCount_set)

    def AddOrRemoveWithNumpyInt(self, IN_ARRAY1, adding):
        return _StGermain.IndexSet_AddOrRemoveWithNumpyInt(self, IN_ARRAY1, adding)

    def AddOrRemoveWithNumpyLong(self, IN_ARRAY1, adding):
        return _StGermain.IndexSet_AddOrRemoveWithNumpyLong(self, IN_ARRAY1, adding)

    def AddOrRemoveWithNumpyUInt(self, IN_ARRAY1, adding):
        return _StGermain.IndexSet_AddOrRemoveWithNumpyUInt(self, IN_ARRAY1, adding)

    def AddOrRemoveWithNumpyULong(self, IN_ARRAY1, adding):
        return _StGermain.IndexSet_AddOrRemoveWithNumpyULong(self, IN_ARRAY1, adding)

    def GetAsNumpyArray(self, INPLACE_ARRAY1):
        return _StGermain.IndexSet_GetAsNumpyArray(self, INPLACE_ARRAY1)

    def __init__(self):
        this = _StGermain.new_IndexSet()
        try:
            self.this.append(this)
        except:
            self.this = this
