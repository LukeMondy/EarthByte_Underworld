...
def stgGenerateFlattenedXML(*args):
  return _StGermain.stgGenerateFlattenedXML(*args)
stgGenerateFlattenedXML = _StGermain.stgGenerateFlattenedXML

def stgMainConstruct(*args):
  return _StGermain.stgMainConstruct(*args)
stgMainConstruct = _StGermain.stgMainConstruct

def stgMainBuildAndInitialise(*args):
  return _StGermain.stgMainBuildAndInitialise(*args)
stgMainBuildAndInitialise = _StGermain.stgMainBuildAndInitialise

def stgMainInitFromXML(*args):
  return _StGermain.stgMainInitFromXML(*args)
stgMainInitFromXML = _StGermain.stgMainInitFromXML

def stgMainLoop(*args):
  return _StGermain.stgMainLoop(*args)
stgMainLoop = _StGermain.stgMainLoop

def stgMainDestroy(*args):
  return _StGermain.stgMainDestroy(*args)
stgMainDestroy = _StGermain.stgMainDestroy

def stgImportToolbox(*args):
  return _StGermain.stgImportToolbox(*args)
...
def BaseExtensibility_Init(*args):
  return _StGermain.BaseExtensibility_Init(*args)
...
class NameSpaceInfo(_object):
    ...
    if _newclass:location = _swig_property(_StGermain.NameSpaceInfo_location_get, _StGermain.NameSpaceInfo_location_set)
    ...
    if _newclass:version = _swig_property(_StGermain.NameSpaceInfo_version_get, _StGermain.NameSpaceInfo_version_set)
    __swig_setmethods__["next"] = _StGermain.NameSpaceInfo_next_set
    __swig_getmethods__["next"] = _StGermain.NameSpaceInfo_next_get
    if _newclass:next = _swig_property(_StGermain.NameSpaceInfo_next_get, _StGermain.NameSpaceInfo_next_set)
    def __init__(self): 
...
class _XML_IO_Handler(_object):
    ...
    if _newclass:_sizeOfSelf = _swig_property(_StGermain._XML_IO_Handler__sizeOfSelf_get, _StGermain._XML_IO_Handler__sizeOfSelf_set)
    ...
    if _newclass:_deleteSelf = _swig_property(_StGermain._XML_IO_Handler__deleteSelf_get, _StGermain._XML_IO_Handler__deleteSelf_set)
    __swig_setmethods__["type"] = _StGermain._XML_IO_Handler_type_set
    __swig_getmethods__["type"] = _StGermain._XML_IO_Handler_type_get
    if _newclass:type = _swig_property(_StGermain._XML_IO_Handler_type_get, _StGermain._XML_IO_Handler_type_set)
    ...
    if _newclass:nRefs = _swig_property(_StGermain._XML_IO_Handler_nRefs_get, _StGermain._XML_IO_Handler_nRefs_set)
    ...
    if _newclass:_delete = _swig_property(_StGermain._XML_IO_Handler__delete_get, _StGermain._XML_IO_Handler__delete_set)
    ...
    if _newclass:_print = _swig_property(_StGermain._XML_IO_Handler__print_get, _StGermain._XML_IO_Handler__print_set)
    ...
    if _newclass:_copy = _swig_property(_StGermain._XML_IO_Handler__copy_get, _StGermain._XML_IO_Handler__copy_set)
    ...
    if _newclass:_readAllFromFile = _swig_property(_StGermain._XML_IO_Handler__readAllFromFile_get, _StGermain._XML_IO_Handler__readAllFromFile_set)
    ...
    if _newclass:_readAllFromBuffer = _swig_property(_StGermain._XML_IO_Handler__readAllFromBuffer_get, _StGermain._XML_IO_Handler__readAllFromBuffer_set)
    ...
    if _newclass:_writeAllToFile = _swig_property(_StGermain._XML_IO_Handler__writeAllToFile_get, _StGermain._XML_IO_Handler__writeAllToFile_set)
    ...
    if _newclass:currDictionary = _swig_property(_StGermain._XML_IO_Handler_currDictionary_get, _StGermain._XML_IO_Handler_currDictionary_set)
    ...
    if _newclass:currSources = _swig_property(_StGermain._XML_IO_Handler_currSources_get, _StGermain._XML_IO_Handler_currSources_set)
    ...
    if _newclass:resource = _swig_property(_StGermain._XML_IO_Handler_resource_get, _StGermain._XML_IO_Handler_resource_set)
    ...
    if _newclass:currPath = _swig_property(_StGermain._XML_IO_Handler_currPath_get, _StGermain._XML_IO_Handler_currPath_set)
    ...
    if _newclass:schema = _swig_property(_StGermain._XML_IO_Handler_schema_get, _StGermain._XML_IO_Handler_schema_set)
    ...
    if _newclass:validate = _swig_property(_StGermain._XML_IO_Handler_validate_get, _StGermain._XML_IO_Handler_validate_set)
    ...
    if _newclass:_writeEntryToFile = _swig_property(_StGermain._XML_IO_Handler__writeEntryToFile_get, _StGermain._XML_IO_Handler__writeEntryToFile_set)
    ...
    if _newclass:_setListEncoding = _swig_property(_StGermain._XML_IO_Handler__setListEncoding_get, _StGermain._XML_IO_Handler__setListEncoding_set)
    ...
    if _newclass:_setWritingPrecision = _swig_property(_StGermain._XML_IO_Handler__setWritingPrecision_get, _StGermain._XML_IO_Handler__setWritingPrecision_set)
    ...
    if _newclass:_setWriteExplicitTypes = _swig_property(_StGermain._XML_IO_Handler__setWriteExplicitTypes_get, _StGermain._XML_IO_Handler__setWriteExplicitTypes_set)
    ...
    if _newclass:nameSpacesList = _swig_property(_StGermain._XML_IO_Handler_nameSpacesList_get, _StGermain._XML_IO_Handler_nameSpacesList_set)
    ...
    if _newclass:currDoc = _swig_property(_StGermain._XML_IO_Handler_currDoc_get, _StGermain._XML_IO_Handler_currDoc_set)
    ...
    if _newclass:currNameSpace = _swig_property(_StGermain._XML_IO_Handler_currNameSpace_get, _StGermain._XML_IO_Handler_currNameSpace_set)
    ...
    if _newclass:tokeniserCalls = _swig_property(_StGermain._XML_IO_Handler_tokeniserCalls_get, _StGermain._XML_IO_Handler_tokeniserCalls_set)
    ...
    if _newclass:listEncoding = _swig_property(_StGermain._XML_IO_Handler_listEncoding_get, _StGermain._XML_IO_Handler_listEncoding_set)
    ...
    if _newclass:typeKeywords = _swig_property(_StGermain._XML_IO_Handler_typeKeywords_get, _StGermain._XML_IO_Handler_typeKeywords_set)
    ...
    if _newclass:TYPE_KEYWORDS = _swig_property(_StGermain._XML_IO_Handler_TYPE_KEYWORDS_get, _StGermain._XML_IO_Handler_TYPE_KEYWORDS_set)
    ...
    if _newclass:writingPrecision = _swig_property(_StGermain._XML_IO_Handler_writingPrecision_get, _StGermain._XML_IO_Handler_writingPrecision_set)
    ...
    if _newclass:writingFieldWidth = _swig_property(_StGermain._XML_IO_Handler_writingFieldWidth_get, _StGermain._XML_IO_Handler_writingFieldWidth_set)
    ...
    if _newclass:WRITING_FIELD_EXTRAS = _swig_property(_StGermain._XML_IO_Handler_WRITING_FIELD_EXTRAS_get, _StGermain._XML_IO_Handler_WRITING_FIELD_EXTRAS_set)
    ...
    if _newclass:writeExplicitTypes = _swig_property(_StGermain._XML_IO_Handler_writeExplicitTypes_get, _StGermain._XML_IO_Handler_writeExplicitTypes_set)
    ...
    if _newclass:writeSources = _swig_property(_StGermain._XML_IO_Handler_writeSources_get, _StGermain._XML_IO_Handler_writeSources_set)
    ...
    if _newclass:searchPathsSize = _swig_property(_StGermain._XML_IO_Handler_searchPathsSize_get, _StGermain._XML_IO_Handler_searchPathsSize_set)
    ...
    if _newclass:searchPaths = _swig_property(_StGermain._XML_IO_Handler_searchPaths_get, _StGermain._XML_IO_Handler_searchPaths_set)
    def __init__(self): 
...
def _XML_IO_Handler_New(*args):
  return _StGermain._XML_IO_Handler_New(*args)
_XML_IO_Handler_New = _StGermain._XML_IO_Handler_New

def XML_IO_Handler_Init(*args):
  return _StGermain.XML_IO_Handler_Init(*args)
XML_IO_Handler_Init = _StGermain.XML_IO_Handler_Init

def _XML_IO_Handler_Init(*args):
  return _StGermain._XML_IO_Handler_Init(*args)
_XML_IO_Handler_Init = _StGermain._XML_IO_Handler_Init

def _XML_IO_Handler_Delete(*args):
  return _StGermain._XML_IO_Handler_Delete(*args)
_XML_IO_Handler_Delete = _StGermain._XML_IO_Handler_Delete

def _XML_IO_Handler_Print(*args):
  return _StGermain._XML_IO_Handler_Print(*args)
_XML_IO_Handler_Print = _StGermain._XML_IO_Handler_Print

def XML_IO_Handler_SetListEncoding(*args):
  return _StGermain.XML_IO_Handler_SetListEncoding(*args)
XML_IO_Handler_SetListEncoding = _StGermain.XML_IO_Handler_SetListEncoding

def _XML_IO_Handler_SetListEncoding(*args):
  return _StGermain._XML_IO_Handler_SetListEncoding(*args)
_XML_IO_Handler_SetListEncoding = _StGermain._XML_IO_Handler_SetListEncoding

def XML_IO_Handler_SetWriteExplicitTypes(*args):
  return _StGermain.XML_IO_Handler_SetWriteExplicitTypes(*args)
XML_IO_Handler_SetWriteExplicitTypes = _StGermain.XML_IO_Handler_SetWriteExplicitTypes

def _XML_IO_Handler_SetWriteExplicitTypes(*args):
  return _StGermain._XML_IO_Handler_SetWriteExplicitTypes(*args)
_XML_IO_Handler_SetWriteExplicitTypes = _StGermain._XML_IO_Handler_SetWriteExplicitTypes

def XML_IO_Handler_SetWritingPrecision(*args):
  return _StGermain.XML_IO_Handler_SetWritingPrecision(*args)
XML_IO_Handler_SetWritingPrecision = _StGermain.XML_IO_Handler_SetWritingPrecision

def _XML_IO_Handler_SetWritingPrecision(*args):
  return _StGermain._XML_IO_Handler_SetWritingPrecision(*args)
_XML_IO_Handler_SetWritingPrecision = _StGermain._XML_IO_Handler_SetWritingPrecision

def _XML_IO_Handler_AddNameSpace(*args):
  return _StGermain._XML_IO_Handler_AddNameSpace(*args)
_XML_IO_Handler_AddNameSpace = _StGermain._XML_IO_Handler_AddNameSpace

def _XML_IO_Handler_CheckNameSpace(*args):
  return _StGermain._XML_IO_Handler_CheckNameSpace(*args)
_XML_IO_Handler_CheckNameSpace = _StGermain._XML_IO_Handler_CheckNameSpace

def _XML_IO_Handler_ReadAllFromFile(*args):
  return _StGermain._XML_IO_Handler_ReadAllFromFile(*args)
_XML_IO_Handler_ReadAllFromFile = _StGermain._XML_IO_Handler_ReadAllFromFile

def _XML_IO_Handler_ReadAllFromFileForceSource(*args):
  return _StGermain._XML_IO_Handler_ReadAllFromFileForceSource(*args)
_XML_IO_Handler_ReadAllFromFileForceSource = _StGermain._XML_IO_Handler_ReadAllFromFileForceSource

def _XML_IO_Handler_ReadAllFromBuffer(*args):
  return _StGermain._XML_IO_Handler_ReadAllFromBuffer(*args)
_XML_IO_Handler_ReadAllFromBuffer = _StGermain._XML_IO_Handler_ReadAllFromBuffer

def _XML_IO_Handler_WriteAllToFile(*args):
  return _StGermain._XML_IO_Handler_WriteAllToFile(*args)
_XML_IO_Handler_WriteAllToFile = _StGermain._XML_IO_Handler_WriteAllToFile

def XML_IO_Handler_WriteEntryToFile(*args):
  return _StGermain.XML_IO_Handler_WriteEntryToFile(*args)
XML_IO_Handler_WriteEntryToFile = _StGermain.XML_IO_Handler_WriteEntryToFile

def _XML_IO_Handler_WriteEntryToFile(*args):
  return _StGermain._XML_IO_Handler_WriteEntryToFile(*args)
_XML_IO_Handler_WriteEntryToFile = _StGermain._XML_IO_Handler_WriteEntryToFile

def XML_IO_Handler_AddDirectory(*args):
  return _StGermain.XML_IO_Handler_AddDirectory(*args)
XML_IO_Handler_AddDirectory = _StGermain.XML_IO_Handler_AddDirectory

def XML_IO_Handler_LibXMLErrorHandler(*args):
  return _StGermain.XML_IO_Handler_LibXMLErrorHandler(*args)
XML_IO_Handler_LibXMLErrorHandler = _StGermain.XML_IO_Handler_LibXMLErrorHandler

def _XML_IO_Handler_WriteAllMem(*args):
  return _StGermain._XML_IO_Handler_WriteAllMem(*args)
...
class _Dictionary(_object):
    ...
    if _newclass:_sizeOfSelf = _swig_property(_StGermain._Dictionary__sizeOfSelf_get, _StGermain._Dictionary__sizeOfSelf_set)
    ...
    if _newclass:_deleteSelf = _swig_property(_StGermain._Dictionary__deleteSelf_get, _StGermain._Dictionary__deleteSelf_set)
    __swig_setmethods__["type"] = _StGermain._Dictionary_type_set
    __swig_getmethods__["type"] = _StGermain._Dictionary_type_get
    if _newclass:type = _swig_property(_StGermain._Dictionary_type_get, _StGermain._Dictionary_type_set)
    __swig_setmethods__["nRefs"] = _StGermain._Dictionary_nRefs_set
    __swig_getmethods__["nRefs"] = _StGermain._Dictionary_nRefs_get
    if _newclass:nRefs = _swig_property(_StGermain._Dictionary_nRefs_get, _StGermain._Dictionary_nRefs_set)
    ...
    if _newclass:_delete = _swig_property(_StGermain._Dictionary__delete_get, _StGermain._Dictionary__delete_set)
    __swig_setmethods__["_print"] = _StGermain._Dictionary__print_set
    __swig_getmethods__["_print"] = _StGermain._Dictionary__print_get
    if _newclass:_print = _swig_property(_StGermain._Dictionary__print_get, _StGermain._Dictionary__print_set)
    __swig_setmethods__["_copy"] = _StGermain._Dictionary__copy_set
    __swig_getmethods__["_copy"] = _StGermain._Dictionary__copy_get
    if _newclass:_copy = _swig_property(_StGermain._Dictionary__copy_get, _StGermain._Dictionary__copy_set)
    __swig_setmethods__["add"] = _StGermain._Dictionary_add_set
    __swig_getmethods__["add"] = _StGermain._Dictionary_add_get
    if _newclass:add = _swig_property(_StGermain._Dictionary_add_get, _StGermain._Dictionary_add_set)
    ...
    if _newclass:addWithSource = _swig_property(_StGermain._Dictionary_addWithSource_get, _StGermain._Dictionary_addWithSource_set)
    __swig_setmethods__["set"] = _StGermain._Dictionary_set_set
    __swig_getmethods__["set"] = _StGermain._Dictionary_set_get
    if _newclass:set = _swig_property(_StGermain._Dictionary_set_get, _StGermain._Dictionary_set_set)
    ...
    if _newclass:setWithSource = _swig_property(_StGermain._Dictionary_setWithSource_get, _StGermain._Dictionary_setWithSource_set)
    __swig_setmethods__["get"] = _StGermain._Dictionary_get_set
    __swig_getmethods__["get"] = _StGermain._Dictionary_get_get
    if _newclass:get = _swig_property(_StGermain._Dictionary_get_get, _StGermain._Dictionary_get_set)
    ...
    if _newclass:getSource = _swig_property(_StGermain._Dictionary_getSource_get, _StGermain._Dictionary_getSource_set)
    __swig_setmethods__["size"] = _StGermain._Dictionary_size_set
    __swig_getmethods__["size"] = _StGermain._Dictionary_size_get
    if _newclass:size = _swig_property(_StGermain._Dictionary_size_get, _StGermain._Dictionary_size_set)
    __swig_setmethods__["delta"] = _StGermain._Dictionary_delta_set
    __swig_getmethods__["delta"] = _StGermain._Dictionary_delta_get
    if _newclass:delta = _swig_property(_StGermain._Dictionary_delta_get, _StGermain._Dictionary_delta_set)
    __swig_setmethods__["count"] = _StGermain._Dictionary_count_set
    __swig_getmethods__["count"] = _StGermain._Dictionary_count_get
    if _newclass:count = _swig_property(_StGermain._Dictionary_count_get, _StGermain._Dictionary_count_set)
    ...
    if _newclass:entryPtr = _swig_property(_StGermain._Dictionary_entryPtr_get, _StGermain._Dictionary_entryPtr_set)
    ...
    if _newclass:debugStream = _swig_property(_StGermain._Dictionary_debugStream_get, _StGermain._Dictionary_debugStream_set)
    def __init__(self): 
...
def _Dictionary_New(*args):
  return _StGermain._Dictionary_New(*args)
_Dictionary_New = _StGermain._Dictionary_New

def _Dictionary_Init(*args):
  return _StGermain._Dictionary_Init(*args)
_Dictionary_Init = _StGermain._Dictionary_Init

def _Dictionary_Delete(*args):
  return _StGermain._Dictionary_Delete(*args)
_Dictionary_Delete = _StGermain._Dictionary_Delete

def _Dictionary_Print(*args):
  return _StGermain._Dictionary_Print(*args)
_Dictionary_Print = _StGermain._Dictionary_Print

def Dictionary_PrintConcise(*args):
  return _StGermain.Dictionary_PrintConcise(*args)
Dictionary_PrintConcise = _StGermain.Dictionary_PrintConcise

def _Dictionary_Copy(*args):
  return _StGermain._Dictionary_Copy(*args)
_Dictionary_Copy = _StGermain._Dictionary_Copy

def Dictionary_Empty(*args):
  return _StGermain.Dictionary_Empty(*args)
Dictionary_Empty = _StGermain.Dictionary_Empty

def Dictionary_Add(*args):
  return _StGermain.Dictionary_Add(*args)
Dictionary_Add = _StGermain.Dictionary_Add

def Dictionary_AddWithSource(*args):
  return _StGermain.Dictionary_AddWithSource(*args)
Dictionary_AddWithSource = _StGermain.Dictionary_AddWithSource

def Dictionary_AddMerge(*args):
  return _StGermain.Dictionary_AddMerge(*args)
Dictionary_AddMerge = _StGermain.Dictionary_AddMerge

def Dictionary_AddMergeWithSource(*args):
  return _StGermain.Dictionary_AddMergeWithSource(*args)
Dictionary_AddMergeWithSource = _StGermain.Dictionary_AddMergeWithSource

def Dictionary_Set(*args):
  return _StGermain.Dictionary_Set(*args)
Dictionary_Set = _StGermain.Dictionary_Set

def Dictionary_SetWithSource(*args):
  return _StGermain.Dictionary_SetWithSource(*args)
Dictionary_SetWithSource = _StGermain.Dictionary_SetWithSource

def Dictionary_Get(*args):
  return _StGermain.Dictionary_Get(*args)
Dictionary_Get = _StGermain.Dictionary_Get

def Dictionary_GetSource(*args):
  return _StGermain.Dictionary_GetSource(*args)
Dictionary_GetSource = _StGermain.Dictionary_GetSource

def Dictionary_GetByIndex(*args):
  return _StGermain.Dictionary_GetByIndex(*args)
Dictionary_GetByIndex = _StGermain.Dictionary_GetByIndex

def Dictionary_GetDefault(*args):
  return _StGermain.Dictionary_GetDefault(*args)
Dictionary_GetDefault = _StGermain.Dictionary_GetDefault

def _Dictionary_Add(*args):
  return _StGermain._Dictionary_Add(*args)
_Dictionary_Add = _StGermain._Dictionary_Add

def _Dictionary_AddWithSource(*args):
  return _StGermain._Dictionary_AddWithSource(*args)
_Dictionary_AddWithSource = _StGermain._Dictionary_AddWithSource

def _Dictionary_Set(*args):
  return _StGermain._Dictionary_Set(*args)
_Dictionary_Set = _StGermain._Dictionary_Set

def _Dictionary_SetWithSource(*args):
  return _StGermain._Dictionary_SetWithSource(*args)
_Dictionary_SetWithSource = _StGermain._Dictionary_SetWithSource

def _Dictionary_Get(*args):
  return _StGermain._Dictionary_Get(*args)
_Dictionary_Get = _StGermain._Dictionary_Get

def _Dictionary_GetSource(*args):
  return _StGermain._Dictionary_GetSource(*args)
_Dictionary_GetSource = _StGermain._Dictionary_GetSource

def _Dictionary_GetByIndex(*args):
  return _StGermain._Dictionary_GetByIndex(*args)
_Dictionary_GetByIndex = _StGermain._Dictionary_GetByIndex

def Dictionary_GetEntry(*args):
  return _StGermain.Dictionary_GetEntry(*args)
Dictionary_GetEntry = _StGermain.Dictionary_GetEntry

def Dictionary_GetEntryByIndex(*args):
  return _StGermain.Dictionary_GetEntryByIndex(*args)
Dictionary_GetEntryByIndex = _StGermain.Dictionary_GetEntryByIndex

def Dictionary_GetCount(*args):
  return _StGermain.Dictionary_GetCount(*args)
Dictionary_GetCount = _StGermain.Dictionary_GetCount

def Dictionary_ReadAllParamFromCommandLine(*args):
  return _StGermain.Dictionary_ReadAllParamFromCommandLine(*args)
Dictionary_ReadAllParamFromCommandLine = _StGermain.Dictionary_ReadAllParamFromCommandLine

def Dictionary_CompareAllEntriesFull(*args):
  return _StGermain.Dictionary_CompareAllEntriesFull(*args)
Dictionary_CompareAllEntriesFull = _StGermain.Dictionary_CompareAllEntriesFull

def _DictionaryUtils_GetRecursive(*args):
  return _StGermain._DictionaryUtils_GetRecursive(*args)
_DictionaryUtils_GetRecursive = _StGermain._DictionaryUtils_GetRecursive

def _DictionaryUtils_AliasDereferenceStruct(*args):
  return _StGermain._DictionaryUtils_AliasDereferenceStruct(*args)
_DictionaryUtils_AliasDereferenceStruct = _StGermain._DictionaryUtils_AliasDereferenceStruct

def _DictionaryUtils_AliasDereferenceList(*args):
  return _StGermain._DictionaryUtils_AliasDereferenceList(*args)
_DictionaryUtils_AliasDereferenceList = _StGermain._DictionaryUtils_AliasDereferenceList

def _DictionaryUtils_AliasDereferenceString(*args):
  return _StGermain._DictionaryUtils_AliasDereferenceString(*args)
_DictionaryUtils_AliasDereferenceString = _StGermain._DictionaryUtils_AliasDereferenceString

def _DictionaryUtils_AliasDereferenceEntryValue(*args):
  return _StGermain._DictionaryUtils_AliasDereferenceEntryValue(*args)
_DictionaryUtils_AliasDereferenceEntryValue = _StGermain._DictionaryUtils_AliasDereferenceEntryValue

def DictionaryUtils_AliasDereferenceDictionary(*args):
  return _StGermain.DictionaryUtils_AliasDereferenceDictionary(*args)
...
class _Dictionary_Entry(_object):
    ...
    if _newclass:key = _swig_property(_StGermain._Dictionary_Entry_key_get, _StGermain._Dictionary_Entry_key_set)
    ...
    if _newclass:value = _swig_property(_StGermain._Dictionary_Entry_value_get, _StGermain._Dictionary_Entry_value_set)
    ...
    if _newclass:units = _swig_property(_StGermain._Dictionary_Entry_units_get, _StGermain._Dictionary_Entry_units_set)
    ...
    if _newclass:source = _swig_property(_StGermain._Dictionary_Entry_source_get, _StGermain._Dictionary_Entry_source_set)
    def __init__(self): 
...
def Dictionary_Entry_New(*args):
  return _StGermain.Dictionary_Entry_New(*args)
Dictionary_Entry_New = _StGermain.Dictionary_Entry_New

def Dictionary_Entry_NewWithSource(*args):
  return _StGermain.Dictionary_Entry_NewWithSource(*args)
Dictionary_Entry_NewWithSource = _StGermain.Dictionary_Entry_NewWithSource

def Dictionary_Entry_Init(*args):
  return _StGermain.Dictionary_Entry_Init(*args)
Dictionary_Entry_Init = _StGermain.Dictionary_Entry_Init

def Dictionary_Entry_Delete(*args):
  return _StGermain.Dictionary_Entry_Delete(*args)
Dictionary_Entry_Delete = _StGermain.Dictionary_Entry_Delete

def Dictionary_Entry_Print(*args):
  return _StGermain.Dictionary_Entry_Print(*args)
Dictionary_Entry_Print = _StGermain.Dictionary_Entry_Print

def Dictionary_Entry_Compare(*args):
  return _StGermain.Dictionary_Entry_Compare(*args)
Dictionary_Entry_Compare = _StGermain.Dictionary_Entry_Compare

def Dictionary_Entry_CompareWithSource(*args):
  return _StGermain.Dictionary_Entry_CompareWithSource(*args)
Dictionary_Entry_CompareWithSource = _StGermain.Dictionary_Entry_CompareWithSource

def Dictionary_Entry_Set(*args):
  return _StGermain.Dictionary_Entry_Set(*args)
Dictionary_Entry_Set = _StGermain.Dictionary_Entry_Set

def Dictionary_Entry_SetWithSource(*args):
  return _StGermain.Dictionary_Entry_SetWithSource(*args)
Dictionary_Entry_SetWithSource = _StGermain.Dictionary_Entry_SetWithSource

def Dictionary_Entry_SetSource(*args):
  return _StGermain.Dictionary_Entry_SetSource(*args)
Dictionary_Entry_SetSource = _StGermain.Dictionary_Entry_SetSource

def Dictionary_Entry_Get(*args):
  return _StGermain.Dictionary_Entry_Get(*args)
Dictionary_Entry_Get = _StGermain.Dictionary_Entry_Get

def Dictionary_Entry_GetSource(*args):
  return _StGermain.Dictionary_Entry_GetSource(*args)
...
class _Dictionary_Entry_Value_List(_object):
    ...
    if _newclass:first = _swig_property(_StGermain._Dictionary_Entry_Value_List_first_get, _StGermain._Dictionary_Entry_Value_List_first_set)
    ...
    if _newclass:last = _swig_property(_StGermain._Dictionary_Entry_Value_List_last_get, _StGermain._Dictionary_Entry_Value_List_last_set)
    ...
    if _newclass:count = _swig_property(_StGermain._Dictionary_Entry_Value_List_count_get, _StGermain._Dictionary_Entry_Value_List_count_set)
    ...
    if _newclass:encoding = _swig_property(_StGermain._Dictionary_Entry_Value_List_encoding_get, _StGermain._Dictionary_Entry_Value_List_encoding_set)
    def __init__(self): 
...
class Dictionary_Entry_Value_AsType(_object):
    ...
    if _newclass:typeString = _swig_property(_StGermain.Dictionary_Entry_Value_AsType_typeString_get, _StGermain.Dictionary_Entry_Value_AsType_typeString_set)
    ...
    if _newclass:typeDouble = _swig_property(_StGermain.Dictionary_Entry_Value_AsType_typeDouble_get, _StGermain.Dictionary_Entry_Value_AsType_typeDouble_set)
    ...
    if _newclass:typeUnsignedInt = _swig_property(_StGermain.Dictionary_Entry_Value_AsType_typeUnsignedInt_get, _StGermain.Dictionary_Entry_Value_AsType_typeUnsignedInt_set)
    ...
    if _newclass:typeInt = _swig_property(_StGermain.Dictionary_Entry_Value_AsType_typeInt_get, _StGermain.Dictionary_Entry_Value_AsType_typeInt_set)
    ...
    if _newclass:typeUnsignedLong = _swig_property(_StGermain.Dictionary_Entry_Value_AsType_typeUnsignedLong_get, _StGermain.Dictionary_Entry_Value_AsType_typeUnsignedLong_set)
    ...
    if _newclass:typeBool = _swig_property(_StGermain.Dictionary_Entry_Value_AsType_typeBool_get, _StGermain.Dictionary_Entry_Value_AsType_typeBool_set)
    ...
    if _newclass:typeStruct = _swig_property(_StGermain.Dictionary_Entry_Value_AsType_typeStruct_get, _StGermain.Dictionary_Entry_Value_AsType_typeStruct_set)
    ...
    if _newclass:typeList = _swig_property(_StGermain.Dictionary_Entry_Value_AsType_typeList_get, _StGermain.Dictionary_Entry_Value_AsType_typeList_set)
    ...
    if _newclass:typeVoid = _swig_property(_StGermain.Dictionary_Entry_Value_AsType_typeVoid_get, _StGermain.Dictionary_Entry_Value_AsType_typeVoid_set)
    def __init__(self): 
...
class _Dictionary_Entry_Value(_object):
    ...
    if _newclass:atType = _swig_property(_StGermain._Dictionary_Entry_Value_atType_get, _StGermain._Dictionary_Entry_Value_atType_set)
    ...
    if _newclass:type = _swig_property(_StGermain._Dictionary_Entry_Value_type_get, _StGermain._Dictionary_Entry_Value_type_set)
    ...
    if _newclass:next = _swig_property(_StGermain._Dictionary_Entry_Value_next_get, _StGermain._Dictionary_Entry_Value_next_set)
    def __init__(self): 
...
def Dictionary_Entry_Value_FromUnsignedInt(*args):
  return _StGermain.Dictionary_Entry_Value_FromUnsignedInt(*args)
Dictionary_Entry_Value_FromUnsignedInt = _StGermain.Dictionary_Entry_Value_FromUnsignedInt

def Dictionary_Entry_Value_InitFromUnsignedInt(*args):
  return _StGermain.Dictionary_Entry_Value_InitFromUnsignedInt(*args)
Dictionary_Entry_Value_InitFromUnsignedInt = _StGermain.Dictionary_Entry_Value_InitFromUnsignedInt

def Dictionary_Entry_Value_FromInt(*args):
  return _StGermain.Dictionary_Entry_Value_FromInt(*args)
Dictionary_Entry_Value_FromInt = _StGermain.Dictionary_Entry_Value_FromInt

def Dictionary_Entry_Value_InitFromInt(*args):
  return _StGermain.Dictionary_Entry_Value_InitFromInt(*args)
Dictionary_Entry_Value_InitFromInt = _StGermain.Dictionary_Entry_Value_InitFromInt

def Dictionary_Entry_Value_FromDouble(*args):
  return _StGermain.Dictionary_Entry_Value_FromDouble(*args)
Dictionary_Entry_Value_FromDouble = _StGermain.Dictionary_Entry_Value_FromDouble

def Dictionary_Entry_Value_InitFromDouble(*args):
  return _StGermain.Dictionary_Entry_Value_InitFromDouble(*args)
Dictionary_Entry_Value_InitFromDouble = _StGermain.Dictionary_Entry_Value_InitFromDouble

def Dictionary_Entry_Value_FromUnsignedLong(*args):
  return _StGermain.Dictionary_Entry_Value_FromUnsignedLong(*args)
Dictionary_Entry_Value_FromUnsignedLong = _StGermain.Dictionary_Entry_Value_FromUnsignedLong

def Dictionary_Entry_Value_InitFromUnsignedLong(*args):
  return _StGermain.Dictionary_Entry_Value_InitFromUnsignedLong(*args)
Dictionary_Entry_Value_InitFromUnsignedLong = _StGermain.Dictionary_Entry_Value_InitFromUnsignedLong

def Dictionary_Entry_Value_FromString(*args):
  return _StGermain.Dictionary_Entry_Value_FromString(*args)
Dictionary_Entry_Value_FromString = _StGermain.Dictionary_Entry_Value_FromString

def Dictionary_Entry_Value_InitFromString(*args):
  return _StGermain.Dictionary_Entry_Value_InitFromString(*args)
Dictionary_Entry_Value_InitFromString = _StGermain.Dictionary_Entry_Value_InitFromString

def Dictionary_Entry_Value_FromStringTo(*args):
  return _StGermain.Dictionary_Entry_Value_FromStringTo(*args)
Dictionary_Entry_Value_FromStringTo = _StGermain.Dictionary_Entry_Value_FromStringTo

def Dictionary_Entry_Value_FromBool(*args):
  return _StGermain.Dictionary_Entry_Value_FromBool(*args)
Dictionary_Entry_Value_FromBool = _StGermain.Dictionary_Entry_Value_FromBool

def Dictionary_Entry_Value_InitFromBool(*args):
  return _StGermain.Dictionary_Entry_Value_InitFromBool(*args)
...
def Dictionary_Entry_Value_InitNewStruct(*args):
  return _StGermain.Dictionary_Entry_Value_InitNewStruct(*args)
Dictionary_Entry_Value_InitNewStruct = _StGermain.Dictionary_Entry_Value_InitNewStruct

def Dictionary_Entry_Value_FromStruct(*args):
  return _StGermain.Dictionary_Entry_Value_FromStruct(*args)
Dictionary_Entry_Value_FromStruct = _StGermain.Dictionary_Entry_Value_FromStruct

def Dictionary_Entry_Value_InitFromStruct(*args):
  return _StGermain.Dictionary_Entry_Value_InitFromStruct(*args)
...
def Dictionary_Entry_Value_InitNewList(*args):
  return _StGermain.Dictionary_Entry_Value_InitNewList(*args)
Dictionary_Entry_Value_InitNewList = _StGermain.Dictionary_Entry_Value_InitNewList

def Dictionary_Entry_Value_AddMember(*args):
  return _StGermain.Dictionary_Entry_Value_AddMember(*args)
Dictionary_Entry_Value_AddMember = _StGermain.Dictionary_Entry_Value_AddMember

def Dictionary_Entry_Value_AddMemberWithSource(*args):
  return _StGermain.Dictionary_Entry_Value_AddMemberWithSource(*args)
Dictionary_Entry_Value_AddMemberWithSource = _StGermain.Dictionary_Entry_Value_AddMemberWithSource

def Dictionary_Entry_Value_AddElement(*args):
  return _StGermain.Dictionary_Entry_Value_AddElement(*args)
Dictionary_Entry_Value_AddElement = _StGermain.Dictionary_Entry_Value_AddElement

def Dictionary_Entry_Value_AddElementWithSource(*args):
  return _StGermain.Dictionary_Entry_Value_AddElementWithSource(*args)
Dictionary_Entry_Value_AddElementWithSource = _StGermain.Dictionary_Entry_Value_AddElementWithSource

def Dictionary_Entry_Value_Delete(*args):
  return _StGermain.Dictionary_Entry_Value_Delete(*args)
Dictionary_Entry_Value_Delete = _StGermain.Dictionary_Entry_Value_Delete

def Dictionary_Entry_Value_Print(*args):
  return _StGermain.Dictionary_Entry_Value_Print(*args)
Dictionary_Entry_Value_Print = _StGermain.Dictionary_Entry_Value_Print

def Dictionary_Entry_Value_SetFrom(*args):
  return _StGermain.Dictionary_Entry_Value_SetFrom(*args)
Dictionary_Entry_Value_SetFrom = _StGermain.Dictionary_Entry_Value_SetFrom

def Dictionary_Entry_Value_SetFromUnsignedInt(*args):
  return _StGermain.Dictionary_Entry_Value_SetFromUnsignedInt(*args)
Dictionary_Entry_Value_SetFromUnsignedInt = _StGermain.Dictionary_Entry_Value_SetFromUnsignedInt

def Dictionary_Entry_Value_SetFromInt(*args):
  return _StGermain.Dictionary_Entry_Value_SetFromInt(*args)
Dictionary_Entry_Value_SetFromInt = _StGermain.Dictionary_Entry_Value_SetFromInt

def Dictionary_Entry_Value_SetFromDouble(*args):
  return _StGermain.Dictionary_Entry_Value_SetFromDouble(*args)
Dictionary_Entry_Value_SetFromDouble = _StGermain.Dictionary_Entry_Value_SetFromDouble

def Dictionary_Entry_Value_SetFromUnsignedLong(*args):
  return _StGermain.Dictionary_Entry_Value_SetFromUnsignedLong(*args)
Dictionary_Entry_Value_SetFromUnsignedLong = _StGermain.Dictionary_Entry_Value_SetFromUnsignedLong

def Dictionary_Entry_Value_SetFromString(*args):
  return _StGermain.Dictionary_Entry_Value_SetFromString(*args)
Dictionary_Entry_Value_SetFromString = _StGermain.Dictionary_Entry_Value_SetFromString

def Dictionary_Entry_Value_SetFromStringKeepCurrentType(*args):
  return _StGermain.Dictionary_Entry_Value_SetFromStringKeepCurrentType(*args)
Dictionary_Entry_Value_SetFromStringKeepCurrentType = _StGermain.Dictionary_Entry_Value_SetFromStringKeepCurrentType

def Dictionary_Entry_Value_SetFromBool(*args):
  return _StGermain.Dictionary_Entry_Value_SetFromBool(*args)
Dictionary_Entry_Value_SetFromBool = _StGermain.Dictionary_Entry_Value_SetFromBool

def Dictionary_Entry_Value_SetNewStruct(*args):
  return _StGermain.Dictionary_Entry_Value_SetNewStruct(*args)
Dictionary_Entry_Value_SetNewStruct = _StGermain.Dictionary_Entry_Value_SetNewStruct

def Dictionary_Entry_Value_SetFromStruct(*args):
  return _StGermain.Dictionary_Entry_Value_SetFromStruct(*args)
Dictionary_Entry_Value_SetFromStruct = _StGermain.Dictionary_Entry_Value_SetFromStruct

def Dictionary_Entry_Value_SetNewList(*args):
  return _StGermain.Dictionary_Entry_Value_SetNewList(*args)
Dictionary_Entry_Value_SetNewList = _StGermain.Dictionary_Entry_Value_SetNewList

def Dictionary_Entry_Value_AsUnsignedInt(*args):
  return _StGermain.Dictionary_Entry_Value_AsUnsignedInt(*args)
Dictionary_Entry_Value_AsUnsignedInt = _StGermain.Dictionary_Entry_Value_AsUnsignedInt

def Dictionary_Entry_Value_AsInt(*args):
  return _StGermain.Dictionary_Entry_Value_AsInt(*args)
Dictionary_Entry_Value_AsInt = _StGermain.Dictionary_Entry_Value_AsInt

def Dictionary_Entry_Value_AsDouble(*args):
  return _StGermain.Dictionary_Entry_Value_AsDouble(*args)
Dictionary_Entry_Value_AsDouble = _StGermain.Dictionary_Entry_Value_AsDouble

def Dictionary_Entry_Value_AsUnsignedLong(*args):
  return _StGermain.Dictionary_Entry_Value_AsUnsignedLong(*args)
Dictionary_Entry_Value_AsUnsignedLong = _StGermain.Dictionary_Entry_Value_AsUnsignedLong

def Dictionary_Entry_Value_AsString(*args):
  return _StGermain.Dictionary_Entry_Value_AsString(*args)
Dictionary_Entry_Value_AsString = _StGermain.Dictionary_Entry_Value_AsString

def Dictionary_Entry_Value_AsBool(*args):
  return _StGermain.Dictionary_Entry_Value_AsBool(*args)
Dictionary_Entry_Value_AsBool = _StGermain.Dictionary_Entry_Value_AsBool

def Dictionary_Entry_Value_AsDictionary(*args):
  return _StGermain.Dictionary_Entry_Value_AsDictionary(*args)
Dictionary_Entry_Value_AsDictionary = _StGermain.Dictionary_Entry_Value_AsDictionary

def Dictionary_Entry_Value_GetFirstElement(*args):
  return _StGermain.Dictionary_Entry_Value_GetFirstElement(*args)
Dictionary_Entry_Value_GetFirstElement = _StGermain.Dictionary_Entry_Value_GetFirstElement

def Dictionary_Entry_Value_GetElement(*args):
  return _StGermain.Dictionary_Entry_Value_GetElement(*args)
Dictionary_Entry_Value_GetElement = _StGermain.Dictionary_Entry_Value_GetElement

def Dictionary_Entry_Value_GetCount(*args):
  return _StGermain.Dictionary_Entry_Value_GetCount(*args)
Dictionary_Entry_Value_GetCount = _StGermain.Dictionary_Entry_Value_GetCount

def Dictionary_Entry_Value_SetEncoding(*args):
  return _StGermain.Dictionary_Entry_Value_SetEncoding(*args)
Dictionary_Entry_Value_SetEncoding = _StGermain.Dictionary_Entry_Value_SetEncoding

def Dictionary_Entry_Value_GetEncoding(*args):
  return _StGermain.Dictionary_Entry_Value_GetEncoding(*args)
Dictionary_Entry_Value_GetEncoding = _StGermain.Dictionary_Entry_Value_GetEncoding

def Dictionary_Entry_Value_SetMember(*args):
  return _StGermain.Dictionary_Entry_Value_SetMember(*args)
Dictionary_Entry_Value_SetMember = _StGermain.Dictionary_Entry_Value_SetMember

def Dictionary_Entry_Value_SetMemberWithSource(*args):
  return _StGermain.Dictionary_Entry_Value_SetMemberWithSource(*args)
Dictionary_Entry_Value_SetMemberWithSource = _StGermain.Dictionary_Entry_Value_SetMemberWithSource

def Dictionary_Entry_Value_GetMember(*args):
  return _StGermain.Dictionary_Entry_Value_GetMember(*args)
Dictionary_Entry_Value_GetMember = _StGermain.Dictionary_Entry_Value_GetMember

def Dictionary_Entry_Value_CompareFull(*args):
  return _StGermain.Dictionary_Entry_Value_CompareFull(*args)
Dictionary_Entry_Value_CompareFull = _StGermain.Dictionary_Entry_Value_CompareFull

def Dictionary_Entry_Value_Copy(*args):
  return _StGermain.Dictionary_Entry_Value_Copy(*args)
