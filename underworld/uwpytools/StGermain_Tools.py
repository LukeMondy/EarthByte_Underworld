...
class StgData(_object):
    ...
    __swig_setmethods__["sources"] = _StGermain_Tools.StgData_sources_set
    __swig_getmethods__["sources"] = _StGermain_Tools.StgData_sources_get
    if _newclass:sources = _swig_property(_StGermain_Tools.StgData_sources_get, _StGermain_Tools.StgData_sources_set)
    __swig_setmethods__["cf"] = _StGermain_Tools.StgData_cf_set
    __swig_getmethods__["cf"] = _StGermain_Tools.StgData_cf_get
    if _newclass:cf = _swig_property(_StGermain_Tools.StgData_cf_get, _StGermain_Tools.StgData_cf_set)
    ...
    __swig_setmethods__["ioHandler"] = _StGermain_Tools.StgData_ioHandler_set
    __swig_getmethods__["ioHandler"] = _StGermain_Tools.StgData_ioHandler_get
    if _newclass:ioHandler = _swig_property(_StGermain_Tools.StgData_ioHandler_get, _StGermain_Tools.StgData_ioHandler_set)
    def __init__(self): 
...
def StgDictAsXMLString(*args):
  return _StGermain_Tools.StgDictAsXMLString(*args)
StgDictAsXMLString = _StGermain_Tools.StgDictAsXMLString

def StgSetDictFromXMLString(*args):
  return _StGermain_Tools.StgSetDictFromXMLString(*args)
StgSetDictFromXMLString = _StGermain_Tools.StgSetDictFromXMLString

def StgAddToDictFromXMLString(*args):
  return _StGermain_Tools.StgAddToDictFromXMLString(*args)
StgAddToDictFromXMLString = _StGermain_Tools.StgAddToDictFromXMLString

def StgConstruct(*args):
  return _StGermain_Tools.StgConstruct(*args)
StgConstruct = _StGermain_Tools.StgConstruct

def StgBuildAndInitialise(*args):
  return _StGermain_Tools.StgBuildAndInitialise(*args)
StgBuildAndInitialise = _StGermain_Tools.StgBuildAndInitialise

def StgMainLoop(*args):
  return _StGermain_Tools.StgMainLoop(*args)
StgMainLoop = _StGermain_Tools.StgMainLoop

def StgRun(*args):
  return _StGermain_Tools.StgRun(*args)
StgRun = _StGermain_Tools.StgRun
