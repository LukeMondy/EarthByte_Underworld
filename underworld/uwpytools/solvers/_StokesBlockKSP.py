...
# RHS vector for mass matrix
    ...
    scratchForceVector = _uwpytools.NewComponentEntryInStgDict( globalDict,
    ...
    mass_matrix = _uwpytools.NewComponentEntryInStgDict( globalDict,
                                name="m_matrix", 
    ...
    mass_matrix_assembly = _uwpytools.NewComponentEntryInStgDict( globalDict,
...
##############################################################################
    ...
    scratchVelForceVector = _uwpytools.NewComponentEntryInStgDict( globalDict,
    ...
    vel_mass_matrix = _uwpytools.NewComponentEntryInStgDict( globalDict,
                                name="vm_matrix", 
                                Type="StiffnessMatrix",
    ...
    vel_mass_matrix_assembly = _uwpytools.NewComponentEntryInStgDict( globalDict,
...
##############################################################################
    ...
    stokesblockkspinterface = _uwpytools.NewComponentEntryInStgDict( globalDict,
